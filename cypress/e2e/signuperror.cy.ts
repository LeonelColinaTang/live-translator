describe("Sign Up Page Error Handling ", () => {
  ...
  it("should display error messages for invalid inputs", () => {
    ...
    cy.getByData("cypress-passwrodConfirm").clear();
    ...
    cy.getByData("cypress-passwrodConfirm").type("short")
    ...
    cy.getByData("cypress-passwrodConfirm").clear().type("password123")
  ...
  it("should display error message when email already exists", () => {
    ...
    cy.getByData("cypress-passwrodConfirm").type("password123")
